...
- Skill neve: `credit-efficient-project-runner`.
- Mikor használtuk: `2026-09-10`, a clean C004.4 checkpoint bounded resume-a, célzott C005 History UI implementáció, Chrome-gate és helyi checkpoint során.
- Mire segített: a History/store/event releváns kódrészeinek szűk olvasására, a full regression tudatos kihagyására, current-byte evidence-re és a protected V003 baseline megőrzésére.
- Mely fájlokat vagy döntéseket érintett: V004 single-file History renderer, C005 tools/evidence/report és projektmeta; skillfájl, V003 release/tag és remote nem változott.
- Kell-e később tanulságot visszaírni a skillbe: `nem`.
