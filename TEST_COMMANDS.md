...
V004-C004 atomic Craft Complete core kapu:

```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\tools\validate-v004-c004.ps1" -PlaywrightModulePath "<workspace Playwright index.mjs abszolút útvonala>"
```
