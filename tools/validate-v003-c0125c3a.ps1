...
$artifactDirectory = Join-Path $projectDirectory "test-artifacts\V003-C012.5C3A"
...
$checks = @(
    ...
    @{ Name = "c0125c3a-target"; File = "node"; Arguments = @((Join-Path $PSScriptRoot "run-v003-c0125c3a-tests.mjs")) },
    ...
    @{ Name = "c0123-quality-direct"; File = "node"; Arguments = @((Join-Path $PSScriptRoot "run-v003-c0123-tests.mjs")) }
)

$lines = [System.Collections.Generic.List[string]]::new()
$lines.Add("V003-C012.5C3A targeted validation")
...
Write-Output "V003_C0125C3A_VALIDATION_PASS exit=0 log=$logPath"
