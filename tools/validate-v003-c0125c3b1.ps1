...
$artifactDirectory = Join-Path $projectDirectory "test-artifacts\V003-C012.5C3B1"
...
$checks = @(
    ...
    @{ Name = "c0125c3b1-target"; File = "node"; Arguments = @((Join-Path $PSScriptRoot "run-v003-c0125c3b1-tests.mjs")) },
...
$lines.Add("V003-C012.5C3B1 targeted validation")
...
Write-Output "V003_C0125C3B1_VALIDATION_PASS exit=0 log=$logPath"
