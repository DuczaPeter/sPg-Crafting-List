...
$artifactDirectory = Join-Path $projectDirectory "test-artifacts\V003-C012.5B"
...
$checks = @(
    ...
    @{ Name = "c0125b-target"; File = "node"; Arguments = @((Join-Path $PSScriptRoot "run-v003-c0125b-tests.mjs")) },
...
$lines.Add("V003-C012.5B targeted validation")
...
Write-Output "V003_C0125B_VALIDATION_PASS exit=0 log=$logPath"
