...
$artifactDirectory = Join-Path $projectDirectory "test-artifacts\V003-C012.5C2"
...
$checks = @(
    ...
    @{ Name = "c0125c2-target"; File = "node"; Arguments = @((Join-Path $PSScriptRoot "run-v003-c0125c2-tests.mjs")) },
...
$lines.Add("V003-C012.5C2 targeted validation")
...
Write-Output "V003_C0125C2_VALIDATION_PASS exit=0 log=$logPath"
