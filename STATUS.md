...
- Aktualis allapot: `V003-dev C010 – EXACT FINAL CRAFTING CARD + CLEAN USER-FACING MAIN VIEW PASS`
...
- Aktualis javitasi ciklus: `V003-C010`
- Utolso sikeres ciklus: `V003-C010`
...
- Aktualis feladat: `C010 default Blueprint Browser + egyetlen Final Card, kulon Crafting List es kompakt standalone lezart`
...
- Utolso frissites: `2026-08-25T09:19:49+02:00`
...
- C010 valodi Chrome localhost: Technical Probe 15/15, kulon Crafting List modul, main es standalone detail Back+reload, 390 px egyoszlopos tulcsordulasmentes layout, quantity `1 -> 2 -> 1` es standalone PASS; fingerprint `d7be3ccc -> d7be3ccc`; alkalmazas/standalone konzol warning/error 0.
